...
# Si el número elegido por el usuario es diferente al número secreto del mago, el usuario debería ver el mensaje "¡Ja, ja! ¡Estás atrapado en mi bucle!"
#  y se le solicitará que ingrese un número nuevamente.
# Si el número ingresado por el usuario coincide con el número escogido por el mago, el número debe imprimirse en la pantalla, y el mago debe decir las siguientes palabras:
...
while numIni != secret_number:
    numIni = int(
        input(
            """
mensaje "¡Ja, ja! ¡Estás atrapado en mi bucle!"
...
print(secret_number, "¡Bien hecho! Eres libre ahora!")
